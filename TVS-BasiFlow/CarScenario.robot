...
Enter Registration  
     [Arguments]   ${Reg}
     Input Text    //input[@id='edit-carreg-no']    ${Reg}  
       
Click Get Quote 
   Click Element    //input[@id='edit-submit'] 

Clear Registration Number
    Clear Element Text    //input[@id='edit-carreg-no']     
    
Select Your Car
    Click Element    //ul[@class='popular-cars popular-cars-cars']/li[1] 
    
Select your Model
    Click Element    (//div[@class='col-md-3 col-xs-4 col-sm-4'])[4] 
    
Select your Fuel Type
    Click Element    //div[@class='row selectyourfueltype']/div[2]  
